...
const ExamPreparation = () => {
  ...
  const examPreparation = [
    {
      ...
      overview: 'Complete IELTS exam preparation guide',
      content: [
        {
          title: 'IELTS Reading',
          description: 'Strategies and practice materials for IELTS Reading',
          file: 'ielts-reading.pdf'
        },
        {
          title: 'IELTS Writing',
          description: 'Tips and sample essays for IELTS Writing',
          file: 'ielts-writing.pdf'
        },
        {
          title: 'IELTS Speaking',
          description: 'Practice questions and tips for IELTS Speaking',
          file: 'ielts-speaking.pdf'
        },
        {
          title: 'IELTS Listening',
          description: 'Practice tests and strategies for IELTS Listening',
          file: 'ielts-listening.pdf'
        }
      ]
    },
    {
      ...
      overview: 'TOEFL exam preparation materials',
      content: [
        {
          title: 'TOEFL Reading',
          description: 'Strategies and practice materials for TOEFL Reading',
          file: 'toefl-reading.pdf'
        },
        {
          title: 'TOEFL Writing',
          description: 'Tips and sample essays for TOEFL Writing',
          file: 'toefl-writing.pdf'
        },
        {
          title: 'TOEFL Speaking',
          description: 'Practice questions and tips for TOEFL Speaking',
          file: 'toefl-speaking.pdf'
        },
        {
          title: 'TOEFL Listening',
          description: 'Practice tests and strategies for TOEFL Listening',
          file: 'toefl-listening.pdf'
        }
      ]
    }
  ];
  ...
  return (
    <div className={`${isFullScreen ? 'fixed inset-0 z-50 bg-white' : 'container mx-auto px-1 py-2'}`}>
      {!isFullScreen && (
        <div className="mb-2">
          <h1 className="flex text-2xl mr-2 font-bold">Exam Preparation
        ...
        {!isFullScreen && (
          <div className="w-full lg:w-1/5">
            <div className="bg-white rounded-lg shadow-md p-2">
              <h2 className="text-[1.1rem] font-semibold mb-2 text-blue-800">Exam Categories</h2>
              <div className="space-y-1 max-h-[300px] lg:max-h-[600px] overflow-y-auto">
                {examPreparation.map((section) => (
          ...
          <div className="bg-white rounded-lg shadow-md px-2 py-1 h-full">
            {selectedFile ? (
              ...
              <div className="flex items-center justify-center h-full">
                <p className="text-gray-500">Select an exam category to view its contents</p>
              </div>
            )}
          </div>
        </div>
