  ...
  return (
    <div className="container mx-auto p-4 text-black"> {/* Default text color */}
      ...
      <p className="mb-0 leading-[28px]">
        ...
        <span className="font-shonar-bangla text-base text-black">সাধারনত পাঁচ রকমের হয়ে থাকে। এগুলো হল-</span>
        <span className="font-lato text-base text-black"> </span>
      </p>
      ...
      <div className="border-l-[1.5pt] border-r-[1.5pt] border-[#0D699B] px-[8px]"> {/* border-left/right:solid #0D699B 1.5pt; padding:0in 6.0pt (8px) */}
        <p className="my-[2px] leading-[28px] p-0"> {/* margin-top/bottom:1.5pt; line-height:21.0pt; padding:0in; */}
          ...
          <span className="font-lato text-base text-black">case </span>
          <span className="font-shonar-bangla text-base text-black">ই আলোচিত হয়</span>
          <span className="font-mangal text-base text-black">।</span>
          <span className="font-lato text-base text-black"> </span>
        </p>
      </div>
      ...
      <p className="mb-0 leading-[28px]">
        ...
        <span className="font-shonar-bangla text-base text-black">বা </span>
        <span className="font-lato text-base text-black">pronoun </span>
        <span className="font-shonar-bangla text-base text-black">কর্তা রুপে ব্যবহৃত হয় তখন তাকে</span>
      ...
      <p className="mb-0 leading-[28px]">
        ...
        <span className="font-lato text-base text-black"> </span>
        <strong className="font-shonar-bangla text-base text-black">ক্রিয়াকে কে (</strong>
      ...
      <p className="mb-0 leading-[28px]">
        ...
        <span className="font-shonar-bangla text-base text-black">স্কুলে যায়</span>
        <span className="font-lato text-base text-black">?]</span>
      </p>
      <p className="mb-0 leading-[28px]">
        <span className="font-shonar-bangla text-base text-black">এছাড়াও </span>
        ...
        <span className="font-shonar-bangla text-base text-black">রূপে ব্যবহৃত হয়</span>
        <span className="font-mangal text-base text-black">।</span>
        <span className="font-lato text-base text-black"> </span>
      </p>
      <p className="mb-0 leading-[28px]">
      ...
      <p className="mb-0 leading-[28px]">
        ...
        <span className="font-shonar-bangla text-base text-black">বা </span>
        <span className="font-lato text-base text-black">pronoun </span>
        <span className="font-shonar-bangla text-base text-black">কর্ম রুপে ব্যবহৃত হয় তখন তাকে </span>
        <span className="font-lato text-base text-black">Objective case </span>
        <span className="font-shonar-bangla text-base text-black">বলে</span>
        <span className="font-mangal text-base text-black">।</span>
        <span className="font-lato text-base text-black"> </span>
      ...
      <p className="mb-0 leading-[28px]">
        ...
        <span className="font-shonar-bangla text-base text-black">কে পেতে হলে ক্রিয়াকে কাকে (</span>
      ...
      <p className="mb-0 leading-[28px]">
        ...
        <span className="font-shonar-bangla text-base text-black">কী পড়ছে</span>
      ...
      <p className="mb-0 leading-[28px]">
        <span className="font-shonar-bangla text-base text-black">অধিকার সম্বন্ধ বা কর্তৃত্ব সম্বন্ধ বোঝায়। এটি "কার" এই প্রশ্নের উত্তর দেয়</span>
        <span className="font-mangal text-base text-black">।</span>
        <span className="font-lato text-base text-black"> </span>
      </p>
      <p className="mb-0 leading-[28px]">
      ...
      <div className="space-y-2 mb-0 leading-[28px] font-lato text-base text-black"> {/* Common styling for these points */}
        <p>
          ...
          <span className="font-shonar-bangla">করা হয়। এটা জীবিত </span>
          <span className="font-lato">noun </span>
          <span className="font-shonar-bangla">এর ক্ষেত্রে হয়। যেমন- </span>
        ...
        <p>
          ...
          <span className="font-shonar-bangla">যোগ করে </span>
          <span className="font-lato">Possessive </span>
          <span className="font-shonar-bangla">করা হয়। যেখানে স-ধ্বনি একাধিক থাকে। যেমন- </span>
        ...
        <p>
          ...
          <span className="font-shonar-bangla">যোগ করে </span>
          <span className="font-lato">Possessive </span>
          <span className="font-shonar-bangla">করা হয়। যেমন- </span>
        ...
        <p>
          ...
          <span className="font-lato">s) </span>
          <span className="font-shonar-bangla">যোগ করতে হয়। যেমন- </span>
        ...
        <p>
          ...
          <span className="font-lato">s) </span>
          <span className="font-shonar-bangla">বসিয়ে বা তার পূর্বে </span>
          <span className="font-lato">of </span>
          <span className="font-shonar-bangla">বসিয়ে </span>
          <span className="font-lato">Possessive </span>
          <span className="font-shonar-bangla">করা হয়। যেমন- </span>
        ...
        <p>
          ...
          <span className="font-lato">s) </span>
          <span className="font-shonar-bangla">না বসিয়ে </span>
          <span className="font-lato">of </span>
          <span className="font-shonar-bangla">বসিয়ে </span>
          <span className="font-lato">Possessive </span>
          <span className="font-shonar-bangla">করতে হয়। যেমন-</span><br />
          <strong>Incorrect</strong> – The Chair's legs are broken.<br />
          <strong>Correct</strong> – The legs of chair are broken.
        </p>
        <p>
          <strong>9.</strong> 
          <span className="font-shonar-bangla">সময়</span>
          ...
          <span className="font-shonar-bangla">যোগ করে </span>
          <span className="font-lato">Possessive </span>
          <span className="font-shonar-bangla">করতে হয়। যেমন – </span>
      ...
      <p className="mb-0 leading-[28px]">
        ...
        <span className="font-mangal text-base text-black">। </span>
        <span className="font-shonar-bangla text-base text-black">এক কথায় বাক্যে </span>
        <span className="font-lato text-base text-black">noun </span>
        <span className="font-shonar-bangla text-base text-black">এর মাধ্যমে কাউকে কে সম্বোধন করে কিছু বলা হলে তার </span>
        <span className="font-lato text-base text-black">Vocative case </span>
        <span className="font-shonar-bangla text-base text-black">হয়। একে </span>
        ...
        <span className="font-shonar-bangla text-base text-black">ও বলা হয়</span>
        <span className="font-mangal text-base text-black">।</span>
        <span className="font-lato text-base text-black"> </span>
      </p>
      <p className="mb-0 leading-[28px]">
