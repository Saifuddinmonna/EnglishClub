...
const SignIn = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Prepare user data for AuthContext (similar to SignUp)
      const userData = {
      ...
      // Use async login function with both parameters
      await login(userData, userProfile);
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Use your student email (@student.edu) to get recognized student access
          </p>
      </div>
