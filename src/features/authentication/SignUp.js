  ...
  const signupMutation = useMutation({
    ...
    onSuccess: async (response, variables) => {
      ...
      const userData = {
        ...
        role: dbUser.role || formData.intendedRole, // Use role from server response
      };
      
      // Send both user data and dbUser to AuthContext
      await login(userData, dbUser);
      console.log('Login context updated with userData:', userData);
      console.log('Login context updated with dbUser:', dbUser);
